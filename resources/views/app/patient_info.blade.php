                ...
                <div class="col-md-12 me-auto">
                    ...
                    <div class="row my-3">
                        ...
                        <label for="address"> ФИО и телефоны родственников: </label>
                            <textarea id="relatives_info" type="text" class="form-control" name="relatives_info">{{$patient->relatives_info}}</textarea>
                    </div>
                    </div>
                    <div class="row my-3">
                    ...
                    <div class="row my-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="disease" class="form-control" value="{{$patient->disease}}" id="disease">
                        </div>
                    </div>
                    <div class="row my-3">
                        ...
                        <div class="col-md-12 col-xxl-12">
                            <textarea id="extra_disease" type="text"  class="form-control" name="extra_disease">{{$patient->extra_disease}}</textarea>
                        </div>
                    </div>
                    <div class="row my-3">
                        <label for="allergy" class="col-form-label">Аллергии</label>
                        <div class="col-sm-12 col-xxl-12">
                            <textarea type="text" name="allergy" class="form-control" id="allergy">{{$patient->allergy}}</textarea>
                        </div>
                    </div>
                    <div class="row my-3">
                        ...
                        <div class="col-xxl-3 col-md-3">
                            ...
                            <div class="">
                                <select name="type_disorder" class="form-select">
                                    <option {{$patient->type_disorder == 'Двигательные' ? 'selected' : ''}}>Двигательные</option>
                                    <option {{$patient->type_disorder == 'Чувствительные' ? 'selected' : ''}}>Чувствительные</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-xxl-3 col-md-3">
                            <label for="orientation" class="col-form-label">Нар-ие ориентации</label>
                            <div class="">
                                <select name="orientation" class="form-select">
                                    <option {{$patient->orientation == 'Отсутствует' ? 'selected' : ''}}>Отсутствует</option>
                                    <option {{$patient->orientation == 'В простанстве' ? 'selected' : ''}}>В простанстве</option>
                                    <option {{$patient->orientation == 'Во времени' ? 'selected' : ''}}>Во времени</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="row my-3">
                        <div class="col-xxl-5 col-md-6">
                            ...
                            <select name="visual_or_sensory_extinction" class="form-select">
                                <option {{$patient->visual_or_sensory_extinction == 'Отсутствует' ? 'selected' : ''}}>Отсутствует</option>
                                <option {{$patient->visual_or_sensory_extinction == 'Зрительное' ? 'selected' : ''}}>Зрительное</option>
                                <option {{$patient->visual_or_sensory_extinction == 'Сенсорное' ? 'selected' : ''}}>Сенсорное</option>
                                <option {{$patient->visual_or_sensory_extinction == 'Присутствуют оба' ? 'selected' : ''}}>Присутствуют оба</option>
                            </select>
                        </div>
                        <div class="col-xxl-3 col-md-3">
                    ...
                    <div class="row my-3">
                        <div class="col-xxl-3 col-md-3">
                            ...
                            <select name="cardio_system" class="form-select">
                                <option {{$patient->cardio_system == 'Без патологи' ? 'selected' : ''}}>Без патологий</option>
                                <option {{$patient->cardio_system == 'АГ' ? 'selected' : ''}}>АГ</option>
                                <option {{$patient->cardio_system == 'ИБС' ? 'selected' : ''}}>ИБС</option>
                                <option {{$patient->cardio_system == 'Фибрилляция предсердий' ? 'selected' : ''}}>Фибрилляция предсердий</option>
                            </select>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-lg-6">
                            <div class="">
                                ...
                                <div class="form-check ">
                                    ...
                                    <div class="col-lg-4">
                                        <input class="form-control" type="text" value="{{$patient->defecation_count}}" name="defecation_count"
