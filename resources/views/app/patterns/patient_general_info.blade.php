<div class="container patient-general-info {{$role}}">
    ...
    <div class="row my-3">
        <label for="disease" class="col-xxl-1 col-md-2 col-form-label">Диагноз</label>
        ...
        <div class="col-xxl-3 col-md-3">
            ...
            <div class="">
                <select name="diabetes" class="form-select">
                    <option {{$patient->diabetes == 'Отсутствует' ? 'selected' : ''}}>
                        Отсутствует
                    </option>
                    <option {{$patient->diabetes == 'Первичный' ? 'selected' : ''}}>
                        Первичный
                    </option>
                    <option {{$patient->diabetes == 'Вторичный' ? 'selected' : ''}}>
                        Вторичный
                    </option>
                </select>
            </div>
        ...
        <div class="col-xxl-3 col-md-3">
            ...
            <div class="">
                <select name="dysphasia" class="form-select">
                    <option {{$patient->dysphasia == 'Отсутствует' ? 'selected' : ''}}>Отсутствует
                    </option>
                    <option {{$patient->dysphasia == 'Сенсорная' ? 'selected' : ''}} >Сенсорная
                    </option>
                    <option {{$patient->dysphasia == 'Моторная' ? 'selected' : ''}}>Моторная
                    </option>
                    <option {{$patient->dysphasia == 'Дизартрия' ? 'selected' : ''}}>Дизартрия
                    </option>
                </select>
            </div>
        </div>
    ...
    <div class="row my-3">
        ...
        <div class="col-xxl-3 col-md-3">
            ...
            <select name="swallowing" class="form-select">
                ...
                <option {{$patient->swallowing == 'Не способен' ? 'selected' : ''}}>Не способен
                </option>
            </select>
        </div>
        <div class="col-xxl-3 col-md-3">
    ...
    <div class="row my-3">
        <div class="col-xxl-3 col-md-3">
            ...
            <select name="cardio_system" class="form-select">
                <option {{$patient->cardio_system == 'Без патологи' ? 'selected' : ''}}>Без
                    патологий
                </option>
    ...
    <div class="row my-3">
        ...
        <div class="col-lg-6">
            <div class="">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="urine_incontinence"
                           value="1"
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="frequent_urination"
                           value="1"
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="urinary_catheter"
                           value="1"
                ...
                <div class="form-check ">
                    ...
                    <div class="col-lg-4">
                        <input class="form-control" type="text"
                               value="{{$patient->defecation_count}}"
